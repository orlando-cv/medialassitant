                                ...
                                <div class="container">
                                    <div class="row fila-datos-paciente">
                                        <div class="col-lg-12 col-datos-paciente">
                                            <h2 class="titulo-segunda-parte">{{ $paciente[0]->nombre }}</h2>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-datos">
                                            ...
                                            @if (empty($consulta->peso))
                                                <p>Peso: <span>--</span></p>
                                            @else
                                                <p>Peso: <span>{{$consulta->peso}} Kg</span></p>                                            
                                            @endif
                                            @if (empty($consulta->estatura))
                                                <p>Estatura: <span>--</span></p>
                                            @else                                          
                                                <p>Estatura: <span>{{$consulta->estatura}} mts</span></p>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <form action="{{ route("consulta.primerdato") }}" method="POST">
                                        ...
                                        @if (empty($consulta))
                                            ...
                                            <div class="ocultar">
                                                <input class="form-control w-75 input-oculto" type="text" name="paciente_id" id="paciente_id" value="{{ $paciente[0]->id }}">
                                            </div>
                                        ...
                                        @else
                                            <div class="row fila-consulta d-flex justify-content-between">
                                                ...
                                                <div class="col-lg-5 d-flex align-items-center justify-content-end no-consulta">
                                                    <label for="no_sesion">No. Sesión:</label>
                                                    <input class="form-control" type="text" value="{{ $consulta->sesion+1 }}" readonly name="no_sesion" id="no_sesion">
                                                </div>
                                            </div>
                                            <div class="ocultar">
                                                <input class="form-control w-75 input-oculto" type="text" name="paciente_id" id="paciente_id" value="{{ $paciente[0]->id }}">
                                            ...
                                            <div class="row fila-datos-consulta">
                                                <div class="col-lg-12">
                                                    <label for="padecimientos">Padecimiento</label>
                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" maxlength="300" name="padecimientos" id="padecimientos"></textarea>
                                                </div>
                                            </div>
                                            <div class="row fila-datos-consulta">
                                                <div class="col-lg-12">
                                                    <label for="antecedentes">Antecedentes:</label>
                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" maxlength="300" name="antecedentes" id="antecedentes"></textarea>
                                                </div>
                                            </div>
                                            <div class="row fila-datos-consulta">
                                                <div class="col-lg-12 d-flex align-items-center">
                                                    <label for="alergias">Alergias:</label>
                                                    <input class="form-control w-100" type="text" name="alergias" id="alergias" value="">
                                                </div>
                                            </div>
                                            <div class="row fila-datos-consulta">
                                                <div class="col-lg-4 d-flex align-items-center justify-content-end">
                                                ...
                                                <div class="col-lg-4 d-flex align-items-center justify-content-end">
                                                    <label for="estatura">Estatura:</label>
                                                    <input class="form-control" type="text" name="estatura" id="estatura" value="">
                                                    {{-- <span class="input-group-text" id="basic-addon2">Mts</span> --}}
                                                </div>
                                                <div class="col-lg-4 d-flex align-items-center justify-content-end">
                                                    <label for="temperatura">Temp:</label>
                                                    <input class="form-control" type="text" name="temperatura" id="temperatura" value="">
                                                    {{-- <span class="input-group-text" id="basic-addon2">°</span> --}}
                                                </div>
                                            </div>
                                            <div class="row fila-datos-consulta">
                                                <div class="col-lg-4 d-flex align-items-center justify-content-end">
                                                    <label for="presion">Presión:</label>
                                                    <input class="form-control" type="text" name="presion" id="presion" value="">
                                                </div>
                                                <div class="col-lg-4 d-flex align-items-center justify-content-end">
                                                    <label for="">Frec. Cardiaca:</label>
                                                    <input class="form-control" type="text" name="fcardiaca" id="fcardiaca" value="">
                                                </div>
                                                <div class="col-lg-4 d-flex align-items-center justify-content-end">
                                                    <label for="">Glucosa:</label>
                                                    <input class="form-control" type="text" name="glucosa" id="glucosa" value="">
                                                </div>
                                            </div>
                                        @endif
                                        <div class="row fila-datos-consulta">
                                    ...
                                    <div class="row fila-tratamientos">
                                        <form action="{{ route('relacion.agregarmed') }}" method="POST">
                                            ...
                                            <div class="ocultar">
                                                ...
                                                @endif
                                                <input class="form-control w-75 input-oculto" type="text" name="paciente_id" value="{{$paciente[0]->id}}">
                                            </div>
